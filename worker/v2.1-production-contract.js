const STAGE_DEFINITIONS = Object.freeze({
  ...
  SCRIPT: Object.freeze({ requires: ['CONCEPT', 'IDEA_SET'], outputs: ['SCRIPT'], parallelGroup: null }),
  ...
  ASSET_PLAN: Object.freeze({ requires: ['PRODUCTION_BIBLE', 'SHOTS'], outputs: ['ASSET_REQUIREMENTS'], parallelGroup: null }),
