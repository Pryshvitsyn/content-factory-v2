...
function qualityProfileFromSelection(selection) {
  ...
  const profile = {
    ...
    modelFamily: selection.modelFamily || null,
    providerModelId: selection.providerModelId || selection.model,
    ...
    capabilityMetadata: Object.freeze({ ...(selection.capabilityMetadata || {}) }),
