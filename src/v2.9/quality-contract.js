...
const REASON_CODES = Object.freeze({
  ...
  TRANSIENT_INTERNAL_DIVIDER: 'TRANSIENT_INTERNAL_DIVIDER',
  PERSISTENT_SPLIT_SCREEN: 'PERSISTENT_SPLIT_SCREEN',
  CONTACT_SHEET_DETECTED: 'CONTACT_SHEET_DETECTED',
  PICTURE_IN_PICTURE_UNEXPECTED: 'PICTURE_IN_PICTURE_UNEXPECTED',
  VISUAL_EVIDENCE_RECONCILIATION: 'VISUAL_EVIDENCE_RECONCILIATION',
  ...
  CONTINUITY_PREDECESSOR_EVIDENCE_MISSING: 'CONTINUITY_PREDECESSOR_EVIDENCE_MISSING',
  CHARACTER_IDENTITY_DRIFT: 'CHARACTER_IDENTITY_DRIFT',
  WARDROBE_CONTINUITY_DRIFT: 'WARDROBE_CONTINUITY_DRIFT',
  ENVIRONMENT_CONTINUITY_DRIFT: 'ENVIRONMENT_CONTINUITY_DRIFT',
  PROP_CONTINUITY_DRIFT: 'PROP_CONTINUITY_DRIFT',
  LIGHTING_COLOR_CONTINUITY_DRIFT: 'LIGHTING_COLOR_CONTINUITY_DRIFT',
  VISUAL_STYLE_CONTINUITY: 'VISUAL_STYLE_CONTINUITY',
  VISUAL_STYLE_CONTINUITY_DRIFT: 'VISUAL_STYLE_CONTINUITY_DRIFT',
  ACTING_STYLE_CONTINUITY: 'ACTING_STYLE_CONTINUITY',
  ACTING_STYLE_CONTINUITY_DRIFT: 'ACTING_STYLE_CONTINUITY_DRIFT',
  CROSS_SHOT_REALISM_CONTINUITY: 'CROSS_SHOT_REALISM_CONTINUITY',
  CROSS_SHOT_REALISM_DRIFT: 'CROSS_SHOT_REALISM_DRIFT',
  CREATIVE_PLAN_MISMATCH: 'CREATIVE_PLAN_MISMATCH',
  SINGLE_COHERENT_COMPOSITION: 'SINGLE_COHERENT_COMPOSITION',
  HUMAN_VISUAL_INTEGRITY: 'HUMAN_VISUAL_INTEGRITY',
  REALISM_QUALITY: 'REALISM_QUALITY',
  BRAND_SAFETY_PROHIBITED_ELEMENT: 'BRAND_SAFETY_PROHIBITED_ELEMENT',
  TEMPORAL_SEMANTIC_CONSISTENCY: 'TEMPORAL_SEMANTIC_CONSISTENCY',
  WARDROBE_CONTINUITY: 'WARDROBE_CONTINUITY',
  LOCATION_CONTINUITY: 'LOCATION_CONTINUITY',
  PROP_CONTINUITY: 'PROP_CONTINUITY',
  LIGHTING_COLOR_CONTINUITY: 'LIGHTING_COLOR_CONTINUITY',
  VISUAL_IDENTITY_CONTINUITY: 'VISUAL_IDENTITY_CONTINUITY',
  SEMANTIC_VISUAL_EVALUATION_NOT_REQUIRED: 'SEMANTIC_VISUAL_EVALUATION_NOT_REQUIRED',
  NOT_EVALUATED_DUE_TO_DETERMINISTIC_BLOCK: 'NOT_EVALUATED_DUE_TO_DETERMINISTIC_BLOCK',
  SEMANTIC_VISUAL_PAID_GATE_REQUIRED: 'SEMANTIC_VISUAL_PAID_GATE_REQUIRED',
  SEMANTIC_VISUAL_EVALUATOR_MALFORMED_RESPONSE: 'SEMANTIC_VISUAL_EVALUATOR_MALFORMED_RESPONSE',
  SEMANTIC_VISUAL_EVALUATOR_TIMEOUT: 'SEMANTIC_VISUAL_EVALUATOR_TIMEOUT',
  SEMANTIC_VISUAL_EVALUATOR_AUTH_FAILED: 'SEMANTIC_VISUAL_EVALUATOR_AUTH_FAILED',
  SEMANTIC_VISUAL_EVALUATOR_RATE_LIMITED: 'SEMANTIC_VISUAL_EVALUATOR_RATE_LIMITED',
  SEMANTIC_VISUAL_EVALUATOR_HTTP_FAILED: 'SEMANTIC_VISUAL_EVALUATOR_HTTP_FAILED',
  SEMANTIC_VISUAL_EVALUATOR_NETWORK_FAILED: 'SEMANTIC_VISUAL_EVALUATOR_NETWORK_FAILED',
...
const HARD_FAILURE_CODES = new Set([
  ...
  REASON_CODES.PERSISTENT_SPLIT_SCREEN,
  ...
  REASON_CODES.BRAND_SAFETY_PROHIBITED_ELEMENT,
  REASON_CODES.FRAME_CORRUPTION,
  REASON_CODES.BLANK_FRAME,
  REASON_CODES.BLACK_FRAME,
  REASON_CODES.WRONG_ORIENTATION,
  REASON_CODES.CHARACTER_IDENTITY_DRIFT,
  REASON_CODES.CONTINUITY_PREDECESSOR_EVIDENCE_MISSING,
