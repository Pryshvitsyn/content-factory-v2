...
const NEGATIVE_PROMPT = 'no white ring, outline, neon rim, halo, glowing border, hard shell edge, poles or polar caps, visible axis, no red, pink or magenta, inverted/negative-photo colors, flashing, camera movement, sphere relocation, background jump, particle explosions, sparks, lightning, audio spectrum/waveform/equalizer, obvious breathing, cartoon squash/stretch, abrupt morphing, cuts, text, logos, watermark, multiple spheres, split screen, collage';
const BASE_PROMPT = 'A single premium living organic sphere suspended centrally in the approved ImpulseOff dark blue-black cosmic scene. Preserve the reference composition: deep #010409 blue-black base, subtle cool blue nebula and haze, sparse dim stars, and a restrained cinematic atmosphere. Keep the background composition and star positions visually stable with no twinkling, drifting, parallax, or brightness jumps. Soft translucent glass-like organic membrane with subtle depth. Slow liquid-like internal masses, smooth volumetric flow, coherent organic material, no discrete particles. Completely locked camera: no zoom, pan, tilt, orbit, dolly, or lens breathing. Motion happens primarily inside the sphere; any expansion is organic internal pressure, never a 2D scale transform. Premium product-film quality, minimal, elegant, calm, physically coherent, never a synthetic UI visualizer.';
