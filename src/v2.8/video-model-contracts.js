...
const SEEDANCE_25=registerVideoModelContract({
  ...
  output:{type:'uri',mediaType:'video/mp4'},pricing:{status:'UNKNOWN_CURRENT_PRICE',unit:'OUTPUT_SECOND'},resolverStrategy:'REPLICATE_FILES_API',technicalQa:{profile:'BASE_VIDEO_QA',expectedContainer:'mp4'},workflowCompatibility:{profiles:['BASE_VIDEO_QA','AVATAR_MOTION_QA','LOOP_CONTENT_QA','AUDIO_VIDEO_QA']},
