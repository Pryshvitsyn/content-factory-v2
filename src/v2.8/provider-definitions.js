...
const MODELS = Object.freeze([
  ...
  { provider: 'replicate', vendor: 'wan-video', modelFamily: 'WAN_2_7_R2V', providerModelId: 'wan-video/wan-2.7-r2v', modelId: 'wan-video/wan-2.7-r2v', displayName: 'Wan 2.7 Reference-to-Video', adapterFamily: 'replicate-wan-2.7-r2v',
    capabilities: [C.REFERENCE_TO_VIDEO], supportStatus: 'SUPPORTED', profiles: profile(['STANDARD'], { STANDARD: { resolution: '720p', duration: 5, shotType: 'single', promptOptimization: false } }),
    constraints: { durationRange: [2,10], resolutions: ['720p','1080p'], aspectRatios: ['16:9','9:16','1:1','4:3','3:4'] }, costStatus: 'VERIFIED', relativeTier: 'STANDARD' },
  ...
  { provider: 'replicate', vendor: 'bytedance', modelFamily: 'SEEDANCE_2_5', providerModelId: 'bytedance/seedance-2.5', modelId: 'bytedance/seedance-2.5', displayName: 'Seedance 2.5', adapterFamily: 'replicate-video-contract',
    capabilities: [C.TEXT_TO_VIDEO,C.IMAGE_TO_VIDEO,C.REFERENCE_TO_VIDEO,C.VIDEO_TO_VIDEO,C.VIDEO_EXTENSION,C.FIRST_FRAME_IMAGE_TO_VIDEO,C.FIRST_LAST_FRAME_VIDEO,C.MULTIMODAL_REFERENCE,C.REFERENCE_IMAGE,C.REFERENCE_VIDEO,C.REFERENCE_AUDIO,C.VIDEO_EDITING,C.NATIVE_AUDIO_GENERATION,C.SEED_CONTROL,C.ADAPTIVE_ASPECT_RATIO,C.VIDEO_OUTPUT,C.NATIVE_AUDIO,C.NATIVE_DIALOGUE,C.NATIVE_AMBIENCE,C.AUDIO_DISABLE_SUPPORTED,C.HYBRID_AUDIO_SUPPORTED], supportStatus: 'SUPPORTED',
    profiles: profile(['ECONOMY','STANDARD','PREMIUM'], { ECONOMY: { resolution: '480p', duration: 5, generateAudio: false }, STANDARD: { resolution: '720p', duration: 5, generateAudio: false }, PREMIUM: { resolution: '1080p', duration: 5, generateAudio: true } }),
    constraints: { durationRange: [4,30], intelligentDuration: -1, resolutions: ['480p','720p','1080p'], aspectRatios: ['adaptive','9:16','16:9','1:1','4:3','3:4'] }, costStatus: 'UNKNOWN', relativeTier: 'STANDARD' },
  ...
  { provider: 'openai', vendor: 'openai', modelFamily: 'OPENAI_IMAGE', providerModelId: 'gpt-image-2', modelId: 'gpt-image-2',
    modelVersion: 'gpt-image-2-2026-04-21', displayName: 'OpenAI GPT Image 2', adapterFamily: 'openai-media',
    capabilities: [C.TEXT_TO_IMAGE,C.IMAGE_TO_IMAGE,C.MULTI_VIEW_IDENTITY_REFERENCE,C.CHARACTER_BODY_REFERENCE,
      C.CHARACTER_EXPRESSION_REFERENCE,C.MOUTH_SHAPE_REFERENCE], supportStatus: 'SUPPORTED',
    lifecycleStatus: 'CURRENT', defaultForNewPlans: true, newPlanPriority: 100,
    profiles: { STANDARD: { resolution: '1024x1024', quality: 'medium' }, PREMIUM: { resolution: '1536x1024', quality: 'high' } },
    constraints: { resolutions: ['1024x1024','1536x1024','1024x1536','2048x2048','2048x1152','3840x2160','2160x3840'],
      aspectRatios: ['1:1','3:2','2:3','16:9','9:16'] }, costStatus: 'PARTIAL', relativeTier: 'PREMIUM',
    pricingVersion: 'openai-image-api-2026-09-01' },
  { provider: 'openai', vendor: 'openai', modelFamily: 'OPENAI_IMAGE', providerModelId: 'gpt-image-1', modelId: 'gpt-image-1', displayName: 'OpenAI GPT Image 1', adapterFamily: 'openai-media',
    capabilities: [C.TEXT_TO_IMAGE,C.IMAGE_TO_IMAGE,C.MULTI_VIEW_IDENTITY_REFERENCE,C.CHARACTER_BODY_REFERENCE,
