...
function createCanonicalMediaRequest(raw = {}) {
  ...
  const base={
    ...
    referenceGeometry: raw.referenceGeometry ? Object.freeze(structuredClone(raw.referenceGeometry)) : null,
...
function fromAsset(asset) {
  ...
  return createCanonicalMediaRequest({
    ...
    referenceGeometry: requirements.v210_reference_evidence || null,
