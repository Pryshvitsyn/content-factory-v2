...
const SOURCE_ROLES = Object.freeze(['IDENTITY','PASSPORT_SOURCE','VOICE_SOURCE','WARDROBE','PRODUCT','LOCATION','STYLE_REFERENCE','PREVIOUS_SHOT']);
...
function roleModalities(roles) {
  ...
  if (roles.includes('IDENTITY') || roles.includes('PASSPORT_SOURCE')) result.add('FACE');
