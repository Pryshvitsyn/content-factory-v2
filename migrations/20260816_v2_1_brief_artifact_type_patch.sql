-- V2.1 BRIEF vertical slice: register the database artifact type used by CONTENT_BRIEF.
-- Keep artifact vocabulary explicit and database-enforced.
...
ALTER TABLE v2_1.artifacts
  ADD CONSTRAINT artifacts_artifact_type_check CHECK (
    artifact_type IN (
      'IDEA_SET','CONTENT_BRIEF','SCRIPT','PRODUCTION_BIBLE','REFERENCE_IMAGE','IMAGE','VIDEO',
