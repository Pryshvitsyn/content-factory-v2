...
ALTER TABLE v2_1.artifacts
  ...
  CHECK (artifact_type IN ('SCRIPT','PRODUCTION_BIBLE','REFERENCE_IMAGE','IMAGE','VIDEO','VOICE','AUDIO','MUSIC','CAPTIONS','CONTINUITY_REPORT','EDIT','FINAL_VIDEO','THUMBNAIL','VALIDATION_REPORT'));
